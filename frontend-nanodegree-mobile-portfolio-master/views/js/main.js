...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var rpcAll = document.querySelectorAll(".randomPizzaContainer");
    for (var i = 0; i < rpcAll.length; i++) {
      rpcAll[i].style.width = newWidth;
    }
  }
...
function updatePositions() {
  ...
  var divide = scrollTop / 1250;
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin((divide)) + (i % 5);
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var pMove = document.querySelector("#movingPizzas1");
